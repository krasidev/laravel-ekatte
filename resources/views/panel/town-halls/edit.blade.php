...
<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('menu.panel.town-halls.edit') }}</div>
    ...
    <div class="card-body">
        <form action="{{ route('panel.town-halls.update', ['town_hall' => $town_hall->id]) }}" method="post" autocomplete="off">
            ...
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $town_hall->code) }}" />
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="ekatte" type="text" class="form-control @error('ekatte') is-invalid @enderror" name="ekatte" value="{{ old('ekatte', $town_hall->ekatte) }}" />
            ...
            <button type="submit" class="btn btn-primary">{{ __('content.panel.town-halls.buttons.update') }}</button>
        </form>
    </div>
</div>
@endsection
