...
<div class="card shadow-sm">
    <div class="card-header bg-transparent d-flex align-items-center">
        ...
        <a href="{{ route('panel.town-halls.export') }}" class="btn flex-shrink-0 ml-auto p-0" data-dt-toggle="tooltip" data-placement="left" title="{{ __('content.panel.town-halls.buttons.export') }}">
