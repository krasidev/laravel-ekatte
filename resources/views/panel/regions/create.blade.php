...
<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('menu.panel.regions.create') }}</div>
    ...
    <div class="card-body">
        <form action="{{ route('panel.regions.store') }}" method="post" autocomplete="off">
            ...
            <button type="submit" class="btn btn-primary">{{ __('content.panel.regions.buttons.store') }}</button>
        </form>
    </div>
</div>
@endsection
