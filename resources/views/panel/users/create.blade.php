...
<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('menu.panel.users.create') }}</div>
    ...
    <div class="card-body">
        <form action="{{ route('panel.users.store') }}" method="post" autocomplete="off">
            ...
            <button type="submit" class="btn btn-primary">{{ __('content.panel.users.buttons.store') }}</button>
        </form>
    </div>
</div>
@endsection
