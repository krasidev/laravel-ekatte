...
<div class="card shadow-sm">
    <div class="card-header bg-transparent">{{ __('menu.panel.districts.edit') }}</div>
    ...
    <div class="card-body">
        <form action="{{ route('panel.districts.update', ['district' => $district->id]) }}" method="post" autocomplete="off">
            ...
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $district->code) }}" />
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="ekatte" type="text" class="form-control @error('ekatte') is-invalid @enderror" name="ekatte" value="{{ old('ekatte', $district->ekatte) }}" />
                ...
                <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $district->name) }}" />
            ...
            <button type="submit" class="btn btn-primary">{{ __('content.panel.districts.buttons.update') }}</button>
        </form>
    </div>
</div>
@endsection
